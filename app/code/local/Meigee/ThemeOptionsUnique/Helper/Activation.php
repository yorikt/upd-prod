 ...
 *
 */
class Meigee_ThemeOptionsUnique_Helper_Activation extends Mage_Core_Helper_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsUnique/etc/blocks.xml';
