...
class Megnor_AdvancedMenu_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawAdvancedMenuItem($category, $level = 0, $last = false)
    {
        ...
        if ($drawPopup)
        {
            ...
            $html[] = '<div id="popup' . $id . '" class="megnor-advanced-menu-popup" onmouseout="megnorHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')" onmouseover="megnorPopupOver(this, event, \'popup' . $id . '\', \'menu' . $id . '\')"><div class="drop-arrow"></div>';
