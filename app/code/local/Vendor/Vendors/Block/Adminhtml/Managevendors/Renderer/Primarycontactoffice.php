<?php
class Vendor_Vendors_Block_Adminhtml_Managevendors_Renderer_Primarycontactoffice extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	public function render(Varien_Object $row)
	{
		...
		$contact_data = '';
		if(!empty($item_data)){
			$contact_data = $item_data['0']['officeno'];
		}
		return $contact_data;		
	}
}
