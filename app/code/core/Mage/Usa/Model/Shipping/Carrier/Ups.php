...
//	echo $_POST['billing']['testtype'];
		if(isset($_POST['billing']['testtype'])) { $destType = $_POST['billing']['testtype']; } // set destionation type using billing info on one page
		if(isset($_POST['shipping']['testtype'])){ $destType = $_POST['shipping']['testtype']; }//set destionation type using shipping info on one page
