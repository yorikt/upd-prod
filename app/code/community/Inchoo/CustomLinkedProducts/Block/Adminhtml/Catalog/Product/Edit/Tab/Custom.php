...
class Inchoo_CustomLinkedProducts_Block_Adminhtml_Catalog_Product_Edit_Tab_Custom extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
		...
		$collection_customer_setting = Mage::getResourceSingleton('producttype/producttype_productrule')
							->getProductCustomerSettings($product_id);
		
		$collection_customer_groups = Mage::getResourceSingleton('producttype/producttype_productrule')
							->getProductCustomerGroup($product_id);
		
		$collection_regions = Mage::getResourceSingleton('producttype/producttype_productrule')
							->getProductRegions($product_id);
							
		
		Mage::register('selectedcustomerproductsetting', $collection_customer_setting);
		Mage::register('selectedcustomergroups', $collection_customer_groups);
		Mage::register('selectedregions', $collection_regions);
		
		$this->setTemplate('catalog/product/edit/customergroup.phtml');
