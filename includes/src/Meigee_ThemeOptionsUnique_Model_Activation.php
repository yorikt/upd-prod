 ...
 *
 */
class Meigee_ThemeOptionsUnique_Model_Activation extends Mage_Core_Model_Abstract
{
    protected $settings;
    private $_file = '/app/code/local/Meigee/ThemeOptionsUnique/etc/import/cms.xml';
