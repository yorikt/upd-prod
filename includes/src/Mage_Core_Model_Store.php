...
//echo $this->_baseUrlCache[$cacheKey];	
...
//echo "yes";
	return str_replace('http://','https://',$this->_baseUrlCache[$cacheKey]);
...
//echo "no";
    ...
    {
	/* ESPL SAN 20150324 0505PM START 
	 * comment following two lines b'cause to remove index.php from admin url
	 */
